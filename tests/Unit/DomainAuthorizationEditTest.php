...
/**
 * Test authorization checks for showing the domain edit form.
 */
class DomainAuthorizationEditTest extends TestCase
{
    ...
    public function testAsGuestRegularDomain()
    {
        ...
        $response = $this->get(route('domain.edit', [
            'domain' => $domain,
        ]));
    ...
    public function testAsUserRegularDomain()
    {
        ...
        $response = $this->actingAs($user)->get(route('domain.edit', [
            'domain' => $domain,
        ]));
